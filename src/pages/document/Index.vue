...
<template>
  <v-card id="account-setting-card">
    ...
    <v-tabs-items v-model="tab">
      <v-tab-item>
        <ListDocument :account-data="accountSettingData.account"></ListDocument>
      </v-tab-item>
...
<script>
// eslint-disable
import { mdiAccountOutline, mdiLockOpenOutline, mdiInformationOutline, mdiClipboardOutline } from '@mdi/js'
...
export default {
  ...
  setup() {
    ...
    // tabs
    const tabs = [
      { title: 'Statistique', icon: mdiAccountOutline },
      { title: 'List des Document', icon: mdiClipboardOutline },
      { title: 'caucher une etape', icon: mdiClipboardOutline },
      { title: 'envoyer ver autre department', icon: mdiClipboardOutline },
    ]
