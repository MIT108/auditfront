...
export default {
  ...
  setup() {
    ...
    // tabs
    const tabs = [
      { title: 'Ajouter un departement', icon: mdiAccountOutline },
      { title: 'List des departement', icon: mdiClipboardOutline },
      { title: 'Envoyer a un departement', icon: mdiInformationOutline },
    ]
